  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-brand-50 via-white to-accent-500/10 dark:from-slate-950 dark:via-slate-950 dark:to-accent-500/5 transition-colors duration-200" />
        <div className="absolute -top-24 -right-24 -z-10 h-80 w-80 rounded-full bg-brand-200/40 dark:bg-brand-500/10 blur-3xl" />
        <div className="absolute -bottom-24 -left-24 -z-10 h-80 w-80 rounded-full bg-accent-500/20 dark:bg-accent-500/10 blur-3xl" />
 
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-16 pb-12 md:pt-24 md:pb-20">
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              <span className="pill bg-brand-100 text-brand-800 dark:bg-brand-950/60 dark:text-brand-300">Alumni community · independent project</span>
              <h1 className="mt-5 text-4xl md:text-5xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
                The alumni network for <span className="bg-gradient-to-r from-brand-800 to-accent-500 dark:from-brand-400 dark:to-accent-500 bg-clip-text text-transparent">Google for Startups Accelerator</span> founders.
              </h1>
            ...
            <div className="relative hidden md:block">
              <div className="card absolute -top-4 left-6 w-72 p-5 rotate-[-3deg] dark:bg-slate-900 dark:ring-slate-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-brand-600 to-accent-500" />
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white">PayWave</div>
              ...
              <div className="card absolute top-16 right-0 w-72 p-5 rotate-[2deg] dark:bg-slate-900 dark:ring-slate-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-accent-500 to-brand-700" />
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white">MedDash</div>
              ...
              <div className="card absolute top-40 left-2 w-72 p-5 rotate-[-1deg] dark:bg-slate-900 dark:ring-slate-800">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-brand-800 to-brand-400" />
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white">VectorAI</div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-end justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Latest in the network</h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">A handful of startups recently added to the directory.</p>
          </div>
          <Link to="/directory" className="text-sm font-semibold text-brand-800 dark:text-brand-400 hover:underline">View all →</Link>
        </div>
        {featured.length === 0 ? (
          <div className="card p-8 text-center text-slate-500 dark:text-slate-400 text-sm">
            No profiles yet — be the first to <Link className="text-brand-800 dark:text-brand-400 font-semibold underline" to="/sign-up">join NetworkZ</Link>.
          </div>
        ) : (
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-20">
        <div className="card relative overflow-hidden p-10 md:p-14 bg-gradient-to-br from-brand-900 to-brand-700 dark:from-brand-950 dark:to-brand-900 text-white ring-0">
          ...
          <p className="mt-3 text-brand-100 dark:text-brand-200 max-w-xl">
