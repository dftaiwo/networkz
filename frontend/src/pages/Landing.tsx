  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-brand-50 via-white to-accent-500/10" />
        <div className="absolute -top-24 -right-24 -z-10 h-80 w-80 rounded-full bg-brand-200/40 blur-3xl" />
        <div className="absolute -bottom-24 -left-24 -z-10 h-80 w-80 rounded-full bg-accent-500/20 blur-3xl" />
              ...
              <div className="card absolute -top-4 left-6 w-72 p-5 rotate-[-3deg]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500">Lagos · Fintech</div>
                  </div>
                </div>
                <div className="mt-3 text-xs text-slate-600">"Mobile-first payments across West Africa."</div>
              </div>
              <div className="card absolute top-16 right-0 w-72 p-5 rotate-[2deg]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500">Nairobi · Healthtech</div>
                  </div>
                </div>
                <div className="mt-3 text-xs text-slate-600">"Telemedicine at scale."</div>
              </div>
              <div className="card absolute top-40 left-2 w-72 p-5 rotate-[-1deg]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500">São Paulo · AI/ML</div>
                  </div>
                </div>
                <div className="mt-3 text-xs text-slate-600">"ML infrastructure for builders."</div>
              </div>
              <div className="h-72" />
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-end justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-slate-900">Latest in the network</h2>
            <p className="text-sm text-slate-600 mt-1">A handful of startups recently added to the directory.</p>
          </div>
